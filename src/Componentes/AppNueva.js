          ...
          <div className="SplitPane row center-xs">
            <div className="  center-xs-12">
              ...
              <div className="SplitPane">
                ...
                <button  onClick={() => alert("Asignar")} className="waves-effect waves-light btn-large botonazul2 center"type="submit">Asignar<i className="large material-icons left">check</i></button>
                </div>
              </div>
            </div>
          </div>
